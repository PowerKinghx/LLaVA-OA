...
class CLIPTrainer:
    def __init__(self, config):
        ...
        logger.info("=" * 60)
        logger.info("Using Weighted Cross-Entropy Loss for class imbalance:")
        for i, (count, weight) in enumerate(zip(class_counts, class_weights)):
            logger.info(f"  KL-{i}: {int(count):4d} samples -> weight {weight:.3f}")
        logger.info("=" * 60)
...
class Config:
    def __init__(self):
        # ========================================================================
        # JMIR Revision: CLIP + Weighted Loss Experiment
        # ========================================================================
